...
class GrocController extends Controller
{
    /**
    ...
    {
        //
        return groc::where('user_id','=',auth()->id())->get();
    ...
    {
        //
        $existeix = groc::where('user_id','=',auth()->id())->first();
        ...
        $valor = Valors::where('producte','=','Groc')->first();
        if ($existeix){
            $dat = groc::find($existeix->id);
        ...
        $diners_dat->save();
        return response()->json([
            'message' => "Operació realitzada. Diners: ".$diners_dat->quantitat." Groc: ".$dat->quantitat,
     ...
     *
     * @param  \App\Models\groc  $groc
     * @return \Illuminate\Http\Response
     */
    public function show(groc $groc)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(groc $groc)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, groc $groc)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(groc $groc)
    {
        //
    }
}
