...
class IndigoController extends Controller
{
    ...
    {
        //
        return indigo::where('user_id','=',auth()->id())->get();
    ...
    {
        //
        $existeix = indigo::where('user_id','=',auth()->id())->first();
        ...
        $valor = Valors::where('producte','=','Indigo')->first();
        if ($existeix){
            $dat = indigo::find($existeix->id);
        ...
        $diners_dat->save();
        return response()->json([
            'message' => "Operació realitzada. Diners: ".$diners_dat->quantitat." Indigo: ".$dat->quantitat,
     ...
     *
     * @param  \App\Models\indigo  $indigo
     * @return \Illuminate\Http\Response
     */
    public function show(indigo $indigo)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(indigo $indigo)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, indigo $indigo)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(indigo $indigo)
    {
        //
    }
}
