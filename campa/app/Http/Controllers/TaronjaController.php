...
class TaronjaController extends Controller
{
    /**
    ...
    {
        //
        return taronja::where('user_id','=',auth()->id())->get();
    ...
    {
        //
        $existeix = taronja::where('user_id','=',auth()->id())->first();
        ...
        $valor = Valors::where('producte','=','Taronja')->first();
        if ($existeix){
            $dat = taronja::find($existeix->id);
        ...
        $diners_dat->save();
        return response()->json([
            'message' => "Operació realitzada. Diners: ".$diners_dat->quantitat." Taronja: ".$dat->quantitat,
     ...
     *
     * @param  \App\Models\taronja  $taronja
     * @return \Illuminate\Http\Response
     */
    public function show(taronja $taronja)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(taronja $taronja)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, taronja $taronja)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(taronja $taronja)
    {
        //
    }
}
